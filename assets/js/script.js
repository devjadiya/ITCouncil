...
/*------------------------------------------
            ...
            submitHandler: function (form) {
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        service: document.getElementById('subject')?.value,
    ...
    /*------------------------------------------
        =TTM CONTACT FORM SUBMISSION
    -------------------------------------------*/

    if ($("#ttm-contactform").length) {
            ...
            submitHandler: function (form) {
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        service: document.getElementById('subject1')?.value,
                        message: document.getElementById('note1')?.value,
                    }),
                    success: function () {
                        // $( "#loader").hide();
                        $( "#ttmSuccess").slideDown( "slow" );
                        setTimeout(function() {
                        $( "#ttmSuccess").slideUp( "slow" );
                        }, 3000);
                        form.reset();
                    },
                    error: function() {
                        // $( "#loader").hide();
                        $( "#ttmError").slideDown( "slow" );
                        setTimeout(function() {
                        $( "#ttmError").slideUp( "slow" );
                        }, 3000);
                    }
                });
                return false; // required to block normal submit since you used ajax
    ...
    ==========================================================================*/
        $(window).on('load', function() {
            ...
            let copyRightTag = document.getElementById('copyRightYear');
            if(copyRightTag) {
                copyRightTag.textContent = (new Date()).getFullYear().toString();
            }
        });
